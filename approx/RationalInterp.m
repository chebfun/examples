...
% [Tags: #rational, #interpolation, #least-squares, #RATINTERP]
...
% pole at $x=1/3$ that gets weaker as $\varepsilon$ decreases to zero (the residue is
% $4\varepsilon/3$), but never goes away so long as $\varepsilon$ is nonzero. One can think of
...
% computation with a tolerance of $0$ rather than the default $10^{-14}$, and that
