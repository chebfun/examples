...
% Sivliu Filip, Yuji Nakatsukasa, and Nick Trefethen, May 2011
...
% This idea led to Chebfun |aaa| algorithm a few months ago [2], and now
% it has further led to an improvement in our capabilities
% for rational best approximation on an interval.  The old |remez| has
% been replaced by a new and much more powerful |minimax| [1].
