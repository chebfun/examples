...
%% Pretty functions
% Chebfun2 has half a dozen plotting commands
% such as `plot`, `plot3`, `surf`, `surfc`, `mesh`,
% and `waterfall`. In this example we use
% some of them to make pretty pictures.

%% Contour and pivot plot 
% The Chebfun2 `contour` command displays level curves and is analogous to the
% MATLAB `contour` command.  On the other hand, the pivot plot, with
% syntax `plot(f,'.')`, displays the locations of the pivots used
...
%% Phase portraits
% For plots of complex valued functions see the Phase
