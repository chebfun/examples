...
% Chebfun to solve a problem involving the normal distribution from the
% textbook [1].  Other similar Examples look at problems from the same book
% involving the exponential, beta, gamma, Rayleigh, and Maxwell distributions.
...
% first we solve the problem as written, and then we solve a variant.

%% 2. Problem 1(d), page 124
% <blockquote>
% If $X$ is normally distributed with mean $2$ and variance $1$,
% find $P[|X-2|<1]$.
% </blockquote>
...
%%
% The factor $1/\sqrt{2\pi\sigma}$ has been deleted because now we will have
% to normalize the distribution by hand. Here is the normalized chebfun:
