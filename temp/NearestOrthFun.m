...
%%
% (Chebfun Example ???/nearestOrthPol.m)
% [Tags: #orthogonal polynomials, #quasimatrix, #SVD, #gallery]

function nearestOrthFun()
%% 
% Suppose $A$ in a given $m \times n$ matrix. The problem of finding the 
...
%    $$ argmin_{U} ||A-U||_{fro} \mbox{ subject to }  U^T U = I. $$
...
%
% Our goal, here, is to generalize this situation to the continuous case. 
% Suppose that a set of functions defined on a domain are given.
% We know how to use Chebfun's _qr_ command to compute orthogonal 
...
fprintf('Departure from orthogonality in the columns of A = %3.2f\n', norm(A'*A-eye(m)))
fprintf('Departure from orthogonality in the columns of Q = %3.2g\n', norm(Q'*Q-eye(m)))
fprintf('Departure from orthogonality in the columns of Q2 = %3.2g\n', norm(Q2'*Q2-eye(m)))
fprintf('The distance between A and Q2 = %3.2f\n', norm(A-Q2,'fro'))
fprintf('The distance between A and its closest orthonormal quasimatrix = %3.2f\n', norm(A-Q,'fro'))
end
%% References
%
...
%
% [3] G.H. Golub, C.F. Van Loan, Matrix Computations, 4th edition, The 
%                Johns Hopkins University Press, 2013.
%
% [4] N.J. Higham, Matrix nearness problems and applications, pp. 1-27, in 
%           Applications of Matrix Theory, Inst. Math. Appl. Conf. 
%           Ser. New Ser., Vol. 22, Oxford Univ. Press, New York, 1989.
%
