...
% constant function, $1$) and antiderivative ($x^2$).
...
%%
% Far away from the left-hand boundary these derivatives are essentially shifts
% of $x \rightarrow x + a\pi/2$ (which is consistent with the case of $a$ being
...
% operators in the Chebop system.
