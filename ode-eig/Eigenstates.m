...
%
% Here $h$ is a small positive parameter with default value
% $h=0.1$ and $V(x)$ is
...
% $h[1, 3, 5, \dots]$.  `quantumstates` permits various
% outputs including just eigenvalues
...
% $L$ is increased, and it is easy to imagine that for $L=\infty$, one
