...
% surface of the unit sphere [1]. It presently supports about 100 commands
% for computing with scalar- and vector-valued functions, and as has some
...
% unique up to an additive constant, the value of which is fixed by
% the mean-value of the initial condition $u_0$ over the sphere.
...
%%
% We can check the the mean value of the approximate solution at $t=1$
% matches the mean value of the initial condition.
u0mean-mean2(u)
