...
% |randnfun2| (and on the sphere with |randnfunsphere|).
% For details, see [1].  Random functions
% in 3D have not yet been implemented.

%%
% In a word, the idea is that a "smooth random function"
% is constructed from a finite Fourier series with independent
% normally distributed random coefficients. A parameter $\lambda$ must
...
%%
% To illustrate, here is a random function with $\lambda = 0.2$ on
