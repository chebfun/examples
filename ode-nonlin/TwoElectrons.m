...
% potential energy is $-4/|z| + 1/\hbox{Im} z$.  Thus the total energy is
% $$ E = |z'|^2 -{4\over |z|} + {1\over \hbox{Im} z}, $$
% and this quantity will be conserved.  For our initial value
% $V=1$, the energy is $E = -2$:
Energy = abs(diff(z)).^2 - 4./abs(z) + 1./imag(z);
plot(Energy), xlabel t, ylabel('Energy(t)')
